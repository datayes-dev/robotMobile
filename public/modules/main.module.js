...
var _searchTitleComponent = require('../components/search.title.component.js');
...
AppModule.annotations = [new _core.NgModule({
  ...
  declarations: [_mainComponent.AppComponent, _searchTitleComponent.SearchTitleComponent], //声明
